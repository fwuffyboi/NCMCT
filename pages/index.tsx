    ...
    return (
        <div className="flex h-screen bg-black text-white items-center justify-center flex lg:h-screen">
            <div className="m-auto">
                ...
                <h1 className="text-2xl">This site is currently in development. </h1>
                <h1 className="text-2xl">If you would like to see the current progress, click the link below.</h1>
